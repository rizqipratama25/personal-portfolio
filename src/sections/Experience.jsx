const experiences = [
  {
    period: "2025",
    role: "Fullstack Developer & Web Scraper",
    company: "PT Universal Big Data",
    description:
      "Developed a salon management application and worked on web scraping and browser automation projects for internal company needs.",
    technologies: [
      "Serenity.is",
      "TypeScript",
      "Tailwind CSS",
