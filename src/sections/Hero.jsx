...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Content */}
      <div className="w-full max-w-7xl mx-auto px-6 lg:px-6 md:px-12 sm:px-8 pt-32 pb-20 relative z-10">
          ...
          <div className="space-y-8">
            <div className="animate-fade-in">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sm text-primary">
                ...
                Software Engineer • React & Laravel Specialist
              </span>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                Hi, I'm Rizqi Pratama - a software engineer specializing in React, Next.js, and Laravel. I build scalable, performant web applications that users love.
              </p>
            </div>
          ...
          <div className="relative animate-fade-in animation-delay-300">
            ...
            <div className="relative max-w-md mx-auto">
              ...
              <div className="relative glass rounded-3xl p-2 glow-border">
                <img src="/my-profile-photo.webp" alt="Rizqi Pratama" className="w-full aspect-4/5 object-cover rounded-2xl" />
