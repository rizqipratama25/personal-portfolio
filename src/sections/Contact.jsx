import { IconAlertCircle, IconCircleCheck, IconMail, IconMapPin, IconPhone, IconSend, IconSend2 } from "@tabler/icons-react";
            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-surface rounded-xl border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all resize-none"></textarea>
              </div>
